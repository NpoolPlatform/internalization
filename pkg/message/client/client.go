...
import (
	...
	msgcli "github.com/NpoolPlatform/go-service-framework/pkg/rabbitmq/client" //nolint
	constant "github.com/NpoolPlatform/internationalization/pkg/message/const"      //nolint
